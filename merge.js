function randomNumberArray(num,min,max){
  ...
  return Math.floor(Math.random() * (max - min)) + min;}result=[]
  for(i=0;i<num;i++){result.push(getRandomInt(min, max))};return result
}
...
function merge(arr1, arr2) {
  ...
  console.log(mergeSort(randomNumberArray(80000,1,100000)));